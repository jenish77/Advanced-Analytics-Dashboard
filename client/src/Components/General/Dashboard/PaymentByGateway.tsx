...
import { PaymentByGatewayTitle, PaymentGrowthTitle } from "@/Constant";

const PaymentByGateway = () => {
  return (
    <Col lg="4" sm="6" className="proorder-xl-3 proorder-md-3">
      <Card className="shifts-char-box">
        <DashboardCommonHeader title={PaymentByGatewayTitle} />
        <CardBody>
...
export default PaymentByGateway;
