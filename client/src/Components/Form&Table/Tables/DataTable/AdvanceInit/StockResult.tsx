        ...
        <CardBody>
          <div className="table-responsive theme-scrollbar">
            <div id="stock_wrapper" className="dataTables_wrapper">
              <DataTable data={filteredItems} persistTableHead columns={StockResultColumn} striped fixedHeader fixedHeaderScrollHeight="50vh" className="display dataTable tbl_custome" subHeader subHeaderComponent={subHeaderComponentMemo} />
            </div>
          </div>
        </CardBody>
      </Card>
