        ...
        <CardBody>
          ...
          <div className="table-responsive">
            <div id="API-1" className="dataTables_wrapper">
              <DataTable data={filteredItems} persistTableHead columns={AddRowColumn} striped={true} pagination className="display theme-scrollbar tbl_custome" subHeader subHeaderComponent={subHeaderComponentMemo} />
            </div>
          </div>
        </CardBody>
      </Card>
