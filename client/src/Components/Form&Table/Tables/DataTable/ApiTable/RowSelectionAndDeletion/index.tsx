        ...
        <CardBody>
          <div className="table-responsive">
            ...
            <div id="row-select-delete">
              <DataTable data={data} persistTableHead columns={DeleteDataColumn} striped highlightOnHover pagination selectableRows onSelectedRowsChange={handleRowSelected} clearSelectedRows={toggleCleared} className="display theme-scrollbar tbl_custome" />
            </div>
          </div>
        </CardBody>
      </Card>
