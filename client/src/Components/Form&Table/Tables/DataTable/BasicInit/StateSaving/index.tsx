      ...
      <Card className="basic-data-table">
        ...
        <CardBody>
          <div className="table-responsive">
            <DataTable className="theme-scrollbar tbl_custome" data={filteredItems} persistTableHead columns={StateSavingColumns} striped pagination subHeader subHeaderComponent={subHeaderComponentMemo} />
          </div>
        </CardBody>
      </Card> 
    </Col>
