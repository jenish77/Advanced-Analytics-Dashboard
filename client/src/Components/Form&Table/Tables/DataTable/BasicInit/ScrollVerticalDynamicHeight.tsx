      ...
      <Card className="basic-data-table">
        ...
        <CardBody>
          <div className="table-responsive user-datatable">
            <DataTable data={filteredItems} persistTableHead columns={ScrollVerticalColumns} striped fixedHeader fixedHeaderScrollHeight="40vh" className="display dataTable tbl_custome" subHeader subHeaderComponent={subHeaderComponentMemo} />
          </div>
        </CardBody>
      </Card>
    </Col>
