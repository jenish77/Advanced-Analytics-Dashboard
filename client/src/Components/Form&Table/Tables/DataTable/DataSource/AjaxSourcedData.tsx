    ...
    <Col sm="12">
      <Card className="basic-data-table">
        ...
        <CardBody>
          ...
          <DataTable data={filteredItems} persistTableHead columns={AjaxSourceColumn} striped highlightOnHover pagination className="display theme-scrollbar tbl_custome" subHeader subHeaderComponent={subHeaderComponentMemo}/>
          </div>
        </CardBody>
      </Card>
    </Col>
