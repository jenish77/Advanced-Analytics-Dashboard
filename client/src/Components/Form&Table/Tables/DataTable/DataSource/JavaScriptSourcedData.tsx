      ...
      <Card className="basic-data-table">
        ...
        <CardBody>
          <div className="table-responsive">
            <DataTable className="theme-scrollbar tbl_custome" persistTableHead data={filteredItems} columns={JavaScriptSourceColumn} striped highlightOnHover pagination subHeader subHeaderComponent={subHeaderComponentMemo} />
          </div>
        </CardBody>
      </Card>
    </Col>
