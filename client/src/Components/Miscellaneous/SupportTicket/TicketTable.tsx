...
const TicketTable = () => {
  ...
  return (
    <div className="table-responsive basic-data-table">
      ...
      <DataTable className="theme-scrollbar tbl_custome" persistTableHead columns={SupportColumnData} data={data} striped={true} pagination selectableRows onSelectedRowsChange={handleRowSelected} clearSelectedRows={toggleDelete} />
    </div>
  );
};
