...
const SubAdminUserListContainer = () => {
                        ...
                        <CardBody>
                            <div className="d-block d-md-flex justify-content-between align-items-start gap-3">
                                ...
                                <div className="list-product-header flex-shrink-0 d-flex gap-2">
                                    <FilterHeader />
                                    <div className="btn btn-primary pt-2 pb-2" onClick={() => setaddSubAdminModalOpen(!addSubAdminModalOpen)}>
...
export default SubAdminUserListContainer;
