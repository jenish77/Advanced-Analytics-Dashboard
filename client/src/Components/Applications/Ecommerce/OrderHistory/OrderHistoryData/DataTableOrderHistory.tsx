      ...
      <Card>
        ...
        <CardBody>
          <div className="order-history table-responsive">
            <DataTable data={filteredItems} persistTableHead columns={OrderHistoryDataColumn} className="dataTables_wrapper no-footer theme-scrollbar tbl_custome" highlightOnHover noHeader pagination paginationServer subHeader subHeaderComponent={subHeaderComponentMemo} />
          </div>
        </CardBody>
      </Card>
    </Col>
