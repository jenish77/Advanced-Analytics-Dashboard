...
export const InvoiceButtons: React.FC<InvoicePrintType> = ({ handlePrint }) => {
  ...
  return (
    <span style={{display: "flex",justifyContent: "center",gap: 15,}} className="pb-5">
      ...
      <Link style={{background: "rgba(122, 112, 186, 0.1)",color: "rgba(122, 112, 186, 1)",borderRadius: 10,padding: "18px 27px",fontSize: 16,fontWeight: 600,outline: 0,border: 0,textDecoration: "none",}} href={`/${i18LangStatus}/ecommerce/product`} download>
        {Cancel}
        <i className="icon-arrow-right" style={{fontSize: 13,fontWeight: "bold",marginLeft: 10,}}/>
      </Link>
    </span>
