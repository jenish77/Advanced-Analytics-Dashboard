...
export const SearchMofi: string = "Search...";
...
export const NoLogOut: string = "Cancel";
...
export const ChangePasswordButton: string = "change password";
...
export const SearchTableButton: string = "Search here..";
...
// Dashboard
export const GoodDayLenaMiller: string = "Good day, John Doe";
...
export const AffiliateOverViewTitle: string = "Affiliate OverView";
export const PaymentGrowthTitle: string = "Payment Growth";
export const PaymentStatisticTitle: string = "Payment Statistic";
export const PaymentByGatewayTitle: string = "Payment By Gateway";
export const WithdrawByGatewayTitle: string = "Withdraw By Gateway";
export const RecentPaymentTitle: string = "Recent Payments";
...
export function createSignature(data: any, secret: any) {
  const joinData = Object.values(data).join(':');
  const finalSig = CryptoJS.HmacSHA256(joinData, secret).toString(CryptoJS.enc.Hex) // generate signature using sha256
  return finalSig
