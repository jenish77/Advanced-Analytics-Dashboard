...
export const TransactionFiltersData = [
  {
    name: "Status",
    options: ["All","Pending","Success","Fail","Cancel","Payment pending"],
  },
  {
    name: "Type",
...
export const AllTransactionTableData = [
  {
    paymentid: 12456257,
    getwaytype: 'Papara',
    intiatied: 'jhgjg',
...
export const ContactListData = [
  {
    merchant_name: 'Sagar',
    subject: 'Occaecat quidem cupi',
    ticket_no: 2804,
    message: 'jyhgjuh jyghjygh jhbgj',
    status: 1
  },
  {
    merchant_name: 'Sagar',
