...
export const PaymentByGatewayChart: ApexOptions = {
  labels: ["Stripe Hosted", "NMI", "Mollie", "Stripe Storefront", "PayStack", "Authorize.net", "RazorPay"],
  series: [40, 26, 18, 12, 8.60, 5.49, 2.04],
  chart: {
    type: "donut",
    height: 200,
  },
...
export const RecentPaymentsTableData = [
  {
    paymentId: "#2232322322",
...
export const CustomerChartData: ApexOptions = {
  series: [
    {
      type: "bar",
      data: [350, 180, 240, 470, 200, 570, 300, 200, 180, 240, 470, 200],
    },
    {
      type: "bar",
      data: [500, 390, 280, 140, 290, 190, 390, 90, 180, 420, 140, 90],
    },
  ],
  chart: {
    height: 350,
